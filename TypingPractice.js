module.exports.TypingPractice = function(userWordsStr, wordsStr, timeTaken) {
    return {
        ...
        getCorrectWords: function(defaultWords, userWordsStr) {
            ...
            let newdefaultWordsList = defaultWords.split(' ')
            newdefaultWordsList = newdefaultWordsList.slice(1, defaultWordsList.length)
            for (let i = 0; i < newdefaultWordsList.length; i++) {
                let defaultWord = newdefaultWordsList[i]
                ...
                if (defaultWord == userWord) {
                    ...
                    if (defaultWord != undefined && userWord != undefined) {
                        incorrectWordsList.push(defaultWord)
